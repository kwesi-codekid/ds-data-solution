        ...
        <main>
          <div className="max-w-5xl mx-auto px-4 md:px-8 flex flex-col md:flex-row md:gap-5">
            ...
            <div className="flex flex-col md:justify-center gap-8 md:flex-1 h-full md:pt-16">
              <h2 className="font-montserrat font-bold text-4xl md:text-5xl lg:text-7xl dark:text-white text-slate-800">
...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  return (await adminController.getAdmin()) ? redirect("/admin/") : null;
};
